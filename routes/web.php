...
use App\Http\Controllers\Livewire\AdminController;
use App\Http\Controllers\Livewire\AjaxController;
...
Route::prefix('ajax')->name('ajax.')->group(function () {
    Route::get('products', [AjaxController::class, 'productsList'])->name('Products');
});
